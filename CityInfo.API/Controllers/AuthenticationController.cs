...
namespace CityInfo.API.Controllers
{
    ...
    public class AuthenticationController : ControllerBase
    {
            ...
            AuthenticationRequestBody authenticationRequestBody)
        {
            ...
            // sub - standardized key for the unique user identifier, could be any value
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claimsForToken,
                // Token will valid from this time
                DateTime.UtcNow,
                // till this time
        ...
        {
            // we don't have user DB or table. If you have, check the passed-through
